      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <span
              onClick={() => router.push("/")}
              className="tracking-widest cursor-pointer select-none text-sm sm:text-lg"
            >
              <span className="animate-spin">👦</span>EMMANUEL TAIWO
            </span>
          </div>
          <div className="ml-auto flex items-center">
            <div className="ml-auto hidden md:block">
              <div className="ml-auto flex items-end space-x-10">
                <li
                  onClick={() => router.push("/")}
                  className="text-neutral-800 font-medium list-none hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm tracking-widest cursor-pointer select-none"
                >
                  HOME
                </li>
